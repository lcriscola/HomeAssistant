...
namespace HomeAssistantGenerated
{
	...
	public class BinarySensorEntities
	{
		...
		///<summary>Real Living Touchscreen Deadbolt: Power Management - Replace battery soon</summary>
		public BinarySensorEntity RealLivingTouchscreenDeadboltPowerManagementReplaceBatterySoon => new(_haContext, "binary_sensor.real_living_touchscreen_deadbolt_power_management_replace_battery_soon");
	...
	public class ButtonEntities
	{
		...
		///<summary>Antonella Temperature Sensor identify</summary>
	...
	public class SensorEntities
	{
		...
		///<summary>LUMI lumi.weather 8a7c6507 humidity</summary>
		public NumericSensorEntity LumiLumiWeather8a7c6507Humidity => new(_haContext, "sensor.lumi_lumi_weather_8a7c6507_humidity");
		///<summary>LUMI lumi.weather 8a7c6507 power</summary>
		public NumericSensorEntity LumiLumiWeather8a7c6507Power => new(_haContext, "sensor.lumi_lumi_weather_8a7c6507_power");
		///<summary>LUMI lumi.weather 8a7c6507 pressure</summary>
		public NumericSensorEntity LumiLumiWeather8a7c6507Pressure => new(_haContext, "sensor.lumi_lumi_weather_8a7c6507_pressure");
		///<summary>Antonella Temperature Sensor Temperature</summary>
		public NumericSensorEntity LumiLumiWeather8a7c6507Temperature => new(_haContext, "sensor.lumi_lumi_weather_8a7c6507_temperature");
	...
	public interface IServices
	{
		...
		RainmachineServices Rainmachine { get; }
	...
	public class Services : IServices
	{
		...
		public RainmachineServices Rainmachine => new(_haContext);
	...
	public class RainmachineServices
	{
		private readonly IHaContext _haContext;
		public RainmachineServices(IHaContext haContext)
		{
			_haContext = haContext;
		}

		///<summary>Pause all watering activities for a number of seconds</summary>
		public void PauseWatering(RainmachinePauseWateringParameters data)
		{
			_haContext.CallService("rainmachine", "pause_watering", null, data);
		}

		///<summary>Pause all watering activities for a number of seconds</summary>
		///<param name="deviceId">The controller whose watering activities should be paused</param>
		///<param name="seconds">The amount of time (in seconds) to pause watering</param>
		public void PauseWatering(string @deviceId, long @seconds)
		{
			_haContext.CallService("rainmachine", "pause_watering", null, new RainmachinePauseWateringParameters{DeviceId = @deviceId, Seconds = @seconds});
		}

		///<summary>Push Weather Data from Home Assistant to the RainMachine device. Local Weather Push service should be enabled from Settings > Weather > Developer tab for RainMachine to consider the values being sent. Units must be sent in metric; no conversions are performed by the integraion. See details of RainMachine API Here: https://rainmachine.docs.apiary.io/#reference/weather-services/parserdata/post</summary>
		public void PushWeatherData(RainmachinePushWeatherDataParameters data)
		{
			_haContext.CallService("rainmachine", "push_weather_data", null, data);
		}

		///<summary>Push Weather Data from Home Assistant to the RainMachine device. Local Weather Push service should be enabled from Settings > Weather > Developer tab for RainMachine to consider the values being sent. Units must be sent in metric; no conversions are performed by the integraion. See details of RainMachine API Here: https://rainmachine.docs.apiary.io/#reference/weather-services/parserdata/post</summary>
		///<param name="deviceId">The controller for the weather data to be pushed.</param>
		///<param name="timestamp">UNIX Timestamp for the Weather Data. If omitted, the RainMachine device's local time at the time of the call is used.</param>
		///<param name="mintemp">Minimum Temperature (°C).</param>
		///<param name="maxtemp">Maximum Temperature (°C).</param>
		///<param name="temperature">Current Temperature (°C).</param>
		///<param name="wind">Wind Speed (m/s)</param>
		///<param name="solarrad">Solar Radiation (MJ/m²/h)</param>
		///<param name="et">Evapotranspiration (mm)</param>
		///<param name="qpf">Quantitative Precipitation Forecast (mm), or QPF. Note: QPF values shouldn't be send as cumulative values but the measured/forecasted values for each hour or day. The RainMachine Mixer will sum all QPF values in the current day to have the day total QPF.</param>
		///<param name="rain">Measured Rainfail (mm). Note: RAIN values shouldn't be send as cumulative values but the measured/forecasted values for each hour or day. The RainMachine Mixer will sum all RAIN values in the current day to have the day total RAIN.</param>
		///<param name="minrh">Min Relative Humidity (%RH)</param>
		///<param name="maxrh">Max Relative Humidity (%RH)</param>
		///<param name="condition">Current weather condition code (WNUM).</param>
		///<param name="pressure">Barametric Pressure (kPa)</param>
		///<param name="dewpoint">Dew Point (°C).</param>
		public void PushWeatherData(string @deviceId, string? @timestamp = null, double? @mintemp = null, double? @maxtemp = null, double? @temperature = null, long? @wind = null, double? @solarrad = null, long? @et = null, long? @qpf = null, long? @rain = null, long? @minrh = null, long? @maxrh = null, string? @condition = null, long? @pressure = null, double? @dewpoint = null)
		{
			_haContext.CallService("rainmachine", "push_weather_data", null, new RainmachinePushWeatherDataParameters{DeviceId = @deviceId, Timestamp = @timestamp, Mintemp = @mintemp, Maxtemp = @maxtemp, Temperature = @temperature, Wind = @wind, Solarrad = @solarrad, Et = @et, Qpf = @qpf, Rain = @rain, Minrh = @minrh, Maxrh = @maxrh, Condition = @condition, Pressure = @pressure, Dewpoint = @dewpoint});
		}

		///<summary>Restrict all watering activities from starting for a time period</summary>
		public void RestrictWatering(RainmachineRestrictWateringParameters data)
		{
			_haContext.CallService("rainmachine", "restrict_watering", null, data);
		}

		///<summary>Restrict all watering activities from starting for a time period</summary>
		///<param name="deviceId">The controller whose watering activities should be restricted</param>
		///<param name="duration">The time period to restrict watering activities from starting</param>
		public void RestrictWatering(string @deviceId, string @duration)
		{
			_haContext.CallService("rainmachine", "restrict_watering", null, new RainmachineRestrictWateringParameters{DeviceId = @deviceId, Duration = @duration});
		}

		///<summary>Start a program</summary>
		///<param name="target">The target for this service call</param>
		public void StartProgram(ServiceTarget target)
		{
			_haContext.CallService("rainmachine", "start_program", target);
		}

		///<summary>Start a zone</summary>
		///<param name="target">The target for this service call</param>
		public void StartZone(ServiceTarget target, RainmachineStartZoneParameters data)
		{
			_haContext.CallService("rainmachine", "start_zone", target, data);
		}

		///<summary>Start a zone</summary>
		///<param name="target">The target for this service call</param>
		///<param name="zoneRunTime">The amount of time (in seconds) to run the zone</param>
		public void StartZone(ServiceTarget target, long? @zoneRunTime = null)
		{
			_haContext.CallService("rainmachine", "start_zone", target, new RainmachineStartZoneParameters{ZoneRunTime = @zoneRunTime});
		}

		///<summary>Stop all watering activities</summary>
		public void StopAll(RainmachineStopAllParameters data)
		{
			_haContext.CallService("rainmachine", "stop_all", null, data);
		}

		///<summary>Stop all watering activities</summary>
		///<param name="deviceId">The controller whose watering activities should be stopped</param>
		public void StopAll(string @deviceId)
		{
			_haContext.CallService("rainmachine", "stop_all", null, new RainmachineStopAllParameters{DeviceId = @deviceId});
		}

		///<summary>Stop a program</summary>
		///<param name="target">The target for this service call</param>
		public void StopProgram(ServiceTarget target)
		{
			_haContext.CallService("rainmachine", "stop_program", target);
		}

		///<summary>Stop a zone</summary>
		///<param name="target">The target for this service call</param>
		public void StopZone(ServiceTarget target)
		{
			_haContext.CallService("rainmachine", "stop_zone", target);
		}

		///<summary>Unpause all paused watering activities</summary>
		public void UnpauseWatering(RainmachineUnpauseWateringParameters data)
		{
			_haContext.CallService("rainmachine", "unpause_watering", null, data);
		}

		///<summary>Unpause all paused watering activities</summary>
		///<param name="deviceId">The controller whose watering activities should be unpaused</param>
		public void UnpauseWatering(string @deviceId)
		{
			_haContext.CallService("rainmachine", "unpause_watering", null, new RainmachineUnpauseWateringParameters{DeviceId = @deviceId});
		}

		///<summary>Unrestrict all watering activities</summary>
		public void UnrestrictWatering(RainmachineUnrestrictWateringParameters data)
		{
			_haContext.CallService("rainmachine", "unrestrict_watering", null, data);
		}

		///<summary>Unrestrict all watering activities</summary>
		///<param name="deviceId">The controller whose watering activities should be unrestricted</param>
		public void UnrestrictWatering(string @deviceId)
		{
			_haContext.CallService("rainmachine", "unrestrict_watering", null, new RainmachineUnrestrictWateringParameters{DeviceId = @deviceId});
		}
	}

	public record RainmachinePauseWateringParameters
	{
		///<summary>The controller whose watering activities should be paused</summary>
		[JsonPropertyName("device_id")]
		public string? DeviceId { get; init; }

		///<summary>The amount of time (in seconds) to pause watering</summary>
		[JsonPropertyName("seconds")]
		public long? Seconds { get; init; }
	}

	public record RainmachinePushWeatherDataParameters
	{
		///<summary>The controller for the weather data to be pushed.</summary>
		[JsonPropertyName("device_id")]
		public string? DeviceId { get; init; }

		///<summary>UNIX Timestamp for the Weather Data. If omitted, the RainMachine device's local time at the time of the call is used.</summary>
		[JsonPropertyName("timestamp")]
		...
		public long? Wind { get; init; }

		///<summary>Solar Radiation (MJ/m²/h)</summary>
		[JsonPropertyName("solarrad")]
		public double? Solarrad { get; init; }

		///<summary>Evapotranspiration (mm)</summary>
		[JsonPropertyName("et")]
		public long? Et { get; init; }

		///<summary>Quantitative Precipitation Forecast (mm), or QPF. Note: QPF values shouldn't be send as cumulative values but the measured/forecasted values for each hour or day. The RainMachine Mixer will sum all QPF values in the current day to have the day total QPF.</summary>
		[JsonPropertyName("qpf")]
		public long? Qpf { get; init; }

		///<summary>Measured Rainfail (mm). Note: RAIN values shouldn't be send as cumulative values but the measured/forecasted values for each hour or day. The RainMachine Mixer will sum all RAIN values in the current day to have the day total RAIN.</summary>
		[JsonPropertyName("rain")]
		public long? Rain { get; init; }

		///<summary>Min Relative Humidity (%RH)</summary>
		[JsonPropertyName("minrh")]
		public long? Minrh { get; init; }

		///<summary>Max Relative Humidity (%RH)</summary>
		[JsonPropertyName("maxrh")]
		public long? Maxrh { get; init; }

		///<summary>Current weather condition code (WNUM).</summary>
		[JsonPropertyName("condition")]
		public string? Condition { get; init; }

		///<summary>Barametric Pressure (kPa)</summary>
		[JsonPropertyName("pressure")]
	...
	public record RainmachineRestrictWateringParameters
	{
		///<summary>The controller whose watering activities should be restricted</summary>
		[JsonPropertyName("device_id")]
		public string? DeviceId { get; init; }

		///<summary>The time period to restrict watering activities from starting</summary>
		[JsonPropertyName("duration")]
		public string? Duration { get; init; }
	}

	public record RainmachineStartZoneParameters
	{
		///<summary>The amount of time (in seconds) to run the zone</summary>
		[JsonPropertyName("zone_run_time")]
		public long? ZoneRunTime { get; init; }
	}

	public record RainmachineStopAllParameters
	{
		///<summary>The controller whose watering activities should be stopped</summary>
		[JsonPropertyName("device_id")]
		public string? DeviceId { get; init; }
	}

	public record RainmachineUnpauseWateringParameters
	{
		///<summary>The controller whose watering activities should be unpaused</summary>
		[JsonPropertyName("device_id")]
		public string? DeviceId { get; init; }
	}

	public record RainmachineUnrestrictWateringParameters
	{
		///<summary>The controller whose watering activities should be unrestricted</summary>
		[JsonPropertyName("device_id")]
		public string? DeviceId { get; init; }
	}
	...
	public static class RainmachineEntityExtensionMethods
	{
		///<summary>Start a program</summary>
		public static void StartProgram(this SwitchEntity target)
		{
			target.CallService("start_program");
		}

		///<summary>Start a program</summary>
		public static void StartProgram(this IEnumerable<SwitchEntity> target)
		{
			target.CallService("start_program");
		}

		///<summary>Start a zone</summary>
		public static void StartZone(this SwitchEntity target, RainmachineStartZoneParameters data)
		{
			target.CallService("start_zone", data);
		}

		///<summary>Start a zone</summary>
		public static void StartZone(this IEnumerable<SwitchEntity> target, RainmachineStartZoneParameters data)
		{
			target.CallService("start_zone", data);
		}
		...
		///<param name="zoneRunTime">The amount of time (in seconds) to run the zone</param>
		public static void StartZone(this SwitchEntity target, long? @zoneRunTime = null)
		{
			target.CallService("start_zone", new RainmachineStartZoneParameters{ZoneRunTime = @zoneRunTime});
		}

		///<summary>Start a zone</summary>
		///<param name="target">The IEnumerable<SwitchEntity> to call this service for</param>
		///<param name="zoneRunTime">The amount of time (in seconds) to run the zone</param>
		public static void StartZone(this IEnumerable<SwitchEntity> target, long? @zoneRunTime = null)
		{
			target.CallService("start_zone", new RainmachineStartZoneParameters{ZoneRunTime = @zoneRunTime});
		}

		///<summary>Stop a program</summary>
		public static void StopProgram(this SwitchEntity target)
		{
			target.CallService("stop_program");
		}

		///<summary>Stop a program</summary>
		public static void StopProgram(this IEnumerable<SwitchEntity> target)
		{
			target.CallService("stop_program");
		}

		///<summary>Stop a zone</summary>
		public static void StopZone(this SwitchEntity target)
		{
			target.CallService("stop_zone");
		}

		///<summary>Stop a zone</summary>
		public static void StopZone(this IEnumerable<SwitchEntity> target)
		{
			target.CallService("stop_zone");
		}
	}
